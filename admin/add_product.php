        ...
        if($run_query){
            ...
            $message ='<div class="alert alert-failure alert-dismissible fade in text-center" style="background-color:white;">
              <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong>The product exists in the inventory.</strong></div>';
            keepmsg($message);
        }else{
            ...
            if($run_query){
                ...
                $message= '<div class="alert alert-failure alert-dismissible fade in text-center" style="background-color:white;">
                          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong>Product registeration unsuccessful. Please try again.</strong></div>'; 
                keepmsg($message); 
            }   
        }
    }
...
<div class ="page-header">
      ...
      <h2 class="text-center" style="color: white;"> Add New Item </h2>
</div>
<div class="row">
