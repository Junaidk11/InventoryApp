...
<?php if(isset($_POST['submit_login'])) {
  ...
  <strong>Sorry!</strong> User already exist. Close this to get redirected to login page. </div>';
    }else{
        ...
        <a href="../index.php" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Registeration successful. Close this to get redirected to login page. </strong> </div>';
            
        }else{
            echo'<div class="alert alert-failure alert-dismissible fade in text-center">
...
<div class ="page-header">
      <div class ="pull-right" style="color: white;border-bottom:white;">
          <a href="inventory.php"><h2 class="pull-right" style="color: white;">Login</h2></a>
      </div>
